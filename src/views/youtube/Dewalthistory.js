...
const Dewalthistory = () => {
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        toast.success('Dewalt Youtube added successfully!')
      ...
      if (result.isConfirmed) {
        try {
          ...
          if (response.data.success) {
            ...
            toast.success('Dewalt Deleted successfully!')
          } else {
  ...
  const handleEditSubmit = async () => {
    try {
      ...
      if (res.data.success) {
        toast.success('Dewalt Youtube updated successfully!')
    ...
    <CRow className="g-4">
      ...
      <CCol xs={12} className="d-flex justify-content-between align-items-center">
        <h4 className="fw-bold mb-0 d-flex align-items-center gap-2">
          {showAddForm
            ? 'Dewalt history Add YouTube Video'
            : showEditForm
              ? 'Dewalt history Edit YouTube Video'
              : 'Dewalt history YouTube Video List'}
