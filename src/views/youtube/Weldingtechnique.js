...
const Weldingtechnique = () => {
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        toast.success('Welding Technique Youtube added successfully!')
  ...
  const handleEditSubmit = async () => {
    try {
      ...
      if (res.data.success) {
        toast.success('Welding Technique Youtube updated successfully!')
    ...
    <CRow className="g-4">
      ...
      <CCol xs={12} className="d-flex justify-content-between align-items-center">
        <h4 className="fw-bold mb-0 d-flex align-items-center gap-2">
          {showAddForm
            ? 'Welding Technique Add YouTube Video'
            : showEditForm
              ? 'Welding Technique Edit YouTube Video'
              : 'Welding Technique YouTube Video List'}
...
export default Weldingtechnique
